...
namespace RegistrationAnd_AccountingOfEquipment {
    ...
    public partial class EquipmentDataSet : global::System.Data.DataSet {
        ...
        public partial class EquipmentDataTable : global::System.Data.TypedTableBase<EquipmentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EquipmentRow AddEquipmentRow(int id, string Name, int Quantity, System.DateTime RegistrationDate) {
...
namespace RegistrationAnd_AccountingOfEquipment.EquipmentDataSetTableAdapters {
    ...
    public partial class EquipmentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Equipment] WHERE (([id] = @Original_id) AND ([Quantity] = @Ori" +
                "ginal_Quantity) AND ([RegistrationDate] = @Original_RegistrationDate))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Equipment] ([id], [Name], [Quantity], [RegistrationDate]) VALU" +
                "ES (@id, @Name, @Quantity, @RegistrationDate);\r\nSELECT id, Name, Quantity, Regis" +
                "trationDate FROM Equipment WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Equipment] SET [id] = @id, [Name] = @Name, [Quantity] = @Quantity, [RegistrationDate] = @RegistrationDate WHERE (([id] = @Original_id) AND ([Quantity] = @Original_Quantity) AND ([RegistrationDate] = @Original_RegistrationDate));
SELECT id, Name, Quantity, RegistrationDate FROM Equipment WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::RegistrationAnd_AccountingOfEquipment.Properties.Settings.Default.ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, Name, Quantity, RegistrationDate FROM dbo.Equipment";
        ...
        public virtual int Delete(int Original_id, int Original_Quantity, System.DateTime Original_RegistrationDate) {
        ...
        public virtual int Insert(int id, string Name, int Quantity, System.DateTime RegistrationDate) {
        ...
        public virtual int Update(int id, string Name, int Quantity, System.DateTime RegistrationDate, int Original_id, int Original_Quantity, System.DateTime Original_RegistrationDate) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, int Quantity, System.DateTime RegistrationDate, int Original_id, int Original_Quantity, System.DateTime Original_RegistrationDate) {
            return this.Update(Original_id, Name, Quantity, RegistrationDate, Original_id, Original_Quantity, Original_RegistrationDate);
        }
    }
